    ...
    <section className="relative min-h-[78vh] md:min-h-[78vh] lg:min-h-[85vh] flex items-center justify-center overflow-hidden pt-20 md:pt-32">
      ...
      <div className="container relative z-10 px-4 text-center flex flex-col items-center">
        <h1 className="text-[28px] md:text-[40px] lg:text-[56px] font-bold leading-tight mb-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          Master Trading & <br className="hidden md:block" />
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
          <Link href="/register">
            <Button className="bg-primary hover:bg-primary/90 text-white font-semibold rounded-lg px-6 py-3 text-base w-full sm:w-auto cursor-pointer hover:scale-105 transition-transform">
              Get Started
            </Button>
          </Link>
          <Link href="/services">
            <Button variant="outline" className="border-white/20 text-white hover:bg-white/10 hover:text-white font-medium rounded-lg px-6 py-3 text-base w-full sm:w-auto cursor-pointer hover:scale-105 transition-transform">
              Our Services
            </Button>
          </Link>
        </div>
