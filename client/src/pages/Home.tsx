...
import communityImage from "@assets/IMG_0089_1763854920962.JPG";
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-8 text-white">Community</h3>
              <div className="grid grid-cols-2 gap-4">
                <img src={communityImage} alt="Community 1" className="w-full aspect-square object-cover rounded-lg opacity-80 hover:opacity-100 transition-opacity" />
